...
// Setup timer and attach timer to a led pin
  ...
  pinMode(4,INPUT);        // TOUCH0 defined as input pin. 
// Setting pin in INPUT or OUTPUT mode could also be done with the Forth word 
// P0ENS ( mask -- )or P0ENC ( mask -- ) Ex: Pin 4 in INPUT is HEX 10 P0ENS
  ...
  HEADER(5,"TOUCH");
  int TOUCH=CODE(4,as_touch,as_next,0,0);
  HEADER(3,"KEY");
  int KEY=COLON(0);
  BEGIN(1,QKEY);
  UNTIL(1,EXITT);
